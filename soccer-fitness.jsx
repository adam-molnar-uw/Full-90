...
function generateWeeks() {
    ...
    days: [
      {
        ...
        notes: "Easy day. Last strength was Saturday. Daily physio only.",
      },
      { day: "Tuesday", type: "rest", label: "Rest + Daily Physio", sessions: [] },
      {
        ...
        sessions: [
          { name: "Movement Prep: A-skip, B-skip only (skip hops, skip Cariocas - PTFJ at 1/10)" },
          ...
          { name: "3. Cable abduction - 17.5lb, 3x12 (bump from 15 if available)." },
        ...
        notes: "First session at 40lb stab lunges and RDLs. Monitor valgus carefully at new weight. Skip calf raises today (ankle fatigue 1/10). Foam roll calves + mid-belly hamstrings after. Piriformis: knee-to-chest across body, NOT figure-four.",
      },
      { day: "Thursday", type: "rest", label: "Rest + Daily Physio", sessions: [], notes: "Save everything for gate test tomorrow." },
      {
        day: "Friday",
        type: "conditioning",
        label: "GATE TEST",
        ...
        sessions: [
          ...
          { name: "GATE TEST: 20 min Z2 + 5 min Z3 + 2 min Z2. Tape-free. Straight-line only. Orthotics in.", zone: "Z2-3" },
          { name: "Post-run: foam roll calves + hamstrings immediately. Again at 2-3 hours." },
        ],
        notes: "This is the session. No PTFJ tape. Monitor 5-hour PTFJ window post-run - must stay clean to pass. If Z3 block feels unsustainable, drop to Z2 and retry next week.",
      },
      {
        day: "Saturday",
        type: "rest",
        ...
        sessions: [],
        notes: "Gate test was yesterday. Monitor PTFJ through today. If 5-hour window was clean and you wake Sunday at 0/10, the gate is PASSED.",
      },
      { day: "Sunday", type: "rest", label: "Full Rest", sessions: [] },
    ],
  });
  ...
  weeks.push({
    number: 9,
    phase: "Soccer-Specific",
    focus: "Introduce linear sprints. First pickup game Friday Apr 10. Two sprint sessions before game.",
    progressionGate: "Tolerates linear sprints without PTFJ flare. First game completed without injury.",
    days: [
      {
        day: "Monday",
        type: "conditioning",
        label: "Sprint Introduction - Strides",
        hrTarget: "Z2-4",
        sessions: [
          { name: "Isometric priming: eversions + calf holds" },
          { name: "Movement Prep (add ankle hops back if PTFJ is 0/10)" },
          ...
          { name: "Post-run: foam roll calves + hamstrings immediately and at 2-3 hours." },
        ],
        notes: "First sprint exposure. Strides, not sprints - controlled acceleration, not max effort. Orthotics in. 5-hour PTFJ window must be clean before progressing Wednesday.",
      },
      {
        day: "Tuesday",
        type: "strength",
        ...
        notes: "Consolidate 40lb on lunges and RDLs. Cable abduction +2.5/week. No plyos this week - strides, sprints, and game are enough reactive load.",
      },
      {
        day: "Wednesday",
        type: "conditioning",
        ...
        sessions: [
          ...
          { name: "Post-run: foam roll immediately and at 2-3 hours." },
        ],
        notes: "Only do this if Monday strides had clean 5-hour window. Second sprint exposure before Friday game. Building from strides to actual sprints. Still straight-line only - no direction changes yet. Keep it controlled - the game Friday is more important than this session.",
      },
      {
        day: "Thursday",
        type: "rest",
        label: "Rest - Pre-Game",
        sessions: [],
        notes: "Daily physio only. Legs must be fresh for first game tomorrow. Isometric priming tonight if you want.",
      },
      {
        day: "Friday",
        type: "conditioning",
        ...
        sessions: [
          ...
          { name: "Post-game: foam roll immediately. Monitor 5-hour PTFJ window." },
        ],
        notes: "Huge milestone. L ankle brace ON. PTFJ tape ON (LaPrade protocol - first game, full protection). Orthotics in boots. H10 on. Come on as sub to manage exposure. If anything flares, come off. The data from this session is your most important benchmark.",
      },
      {
        day: "Saturday",
        type: "rest",
        ...
        sessions: [],
        notes: "Assess: how did the game feel? PTFJ score? Ankle? Any new issues? This data determines Week 10 planning.",
      },
      { day: "Sunday", type: "rest", label: "Full Rest", sessions: [] },
    ],
  });
    ...
    days: [
      {
        ...
        hrTarget: "Z4-5",
        sessions: [
          { name: "Movement Prep + isometric priming (add Cariocas back if PTFJ 0/10)" },
          { name: "10 min Z2 jog", zone: "Z2" },
        ...
        notes: "First multi-directional work. Lateral shuffle only - no sharp cutting yet. L ankle: tape/brace on, control every direction change. If ankle feels sloppy, stop agility and jog out. Foam roll after.",
      },
      {
        day: "Tuesday",
        type: "strength",
        ...
        notes: "Peak strength week. Hit target weights. If valgus under 45lb, drop to 40 and maintain. No structured plyos - game provides reactive stimulus.",
      },
      { day: "Wednesday", type: "rest", label: "Rest + Daily Physio", sessions: [] },
      {
        day: "Thursday",
        ...
        sessions: [
          ...
          { name: "Agility circuit x 6 reps (higher intensity than Monday)", zone: "Z4-5" },
          { name: "8 min jog cool-down", zone: "Z2" },
        ],
        notes: "First RSA session. Only progress agility intensity if Monday was clean. L ankle: stop if control deteriorates. Tape/brace on.",
      },
      {
        day: "Friday",
        type: "conditioning",
        ...
        hrTarget: "Z1",
        sessions: [{ name: "20 min easy walk", zone: "Z1" }],
        notes: "Fresh legs for game tomorrow.",
      },
      {
        day: "Saturday",
        type: "conditioning",
        ...
        sessions: [
          ...
          { name: "Target: 60-75 min. Start from the beginning if possible." },
        ],
        notes: "Push duration from Week 9. Ankle brace on. Wean PTFJ tape if Week 9 game was clean (try without, have tape on sideline). H10: compare to Week 9 data.",
      },
      { day: "Sunday", type: "rest", label: "Full Rest", sessions: [] },
    ],
  });
    ...
    days: [
      {
        ...
        notes: "Longest match sim. 55 min total mixed-intensity work.",
      },
      {
        day: "Tuesday",
        type: "strength",
      ...
      { day: "Wednesday", type: "rest", label: "Rest + Daily Physio", sessions: [] },
      {
        ...
        notes: "Peak sprint and agility volume. Drop set 4 if crushed by set 3. L ankle: stop agility if control deteriorates. Tape/brace on. Last peak session.",
      },
      {
        day: "Friday",
        type: "conditioning",
      ...
      },
      {
        ...
        notes: "Play as close to full game duration as possible. Last heavy game week. H10 data is your match-readiness benchmark.",
      },
      { day: "Sunday", type: "rest", label: "Full Rest", sessions: [] },
    ],
  });
  ...
  weeks.push({
    ...
    days: [
      ...
      },
      {
        ...
        notes: "Same weights, fewer sets. Maintaining neural patterns without fatigue. Supercompensation is happening.",
      },
      { day: "Wednesday", type: "rest", label: "Rest + Daily Physio", sessions: [] },
      {
        day: "Thursday",
        ...
        notes: "Reduced from 4 sets to 2. Maintaining speed without accumulating fatigue.",
      },
      {
        day: "Friday",
        type: "rest",
  ...
  weeks.push({
    ...
    progressionGate: "Feeling fast and fresh. Legs feel light. Resting HR at baseline.",
    days: [
      {
        day: "Monday",
        type: "conditioning",
      ...
      },
      {
        ...
        sessions: [
          { name: "1. Stab lunges - 2x45lb, 2x6. Activation." },
          ...
          { name: "6. Nordic curls - 2x3 eccentric." },
      ...
      { day: "Wednesday", type: "rest", label: "Rest + Daily Physio", sessions: [] },
      {
        ...
        sessions: [
          { name: "10 min jog", zone: "Z2" },
          { name: "6x20m sprints with full recovery", zone: "Z5" },
      ...
      },
      {
        ...
        notes: "Last game before match week. Stay healthy. Nothing to prove.",
      },
      { day: "Sunday", type: "rest", label: "Full Rest", sessions: [] },
    ],
  });
    ...
    days: [
      ...
      },
      {
        ...
        sessions: [
          ...
          { name: "Calf raises - bodyweight 2x10." },
          { name: "UPPER BODY: DB bench 2x6 light, DB shoulder press 2x6 light." },
        ],
        notes: "Light weights, low reps. No soreness allowed.",
      },
      { day: "Wednesday", type: "rest", label: "Rest + Daily Physio", sessions: [] },
      {
        day: "Thursday",
      ...
      },
      {
        ...
        label: "Full Rest",
        sessions: [],
        notes: "Sleep 8+ hours. Hydrate. Eat well. Prep kit: boots + orthotics + ankle brace + tape.",
      },
      {
        day: "Saturday",
        type: "conditioning",
        ...
        notes: "Just feel loose. Pack your bag tonight. H10 charged.",
      },
      {
        day: "Sunday",
        type: "match",
