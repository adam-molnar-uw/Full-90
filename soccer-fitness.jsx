    ...
    days: [
      ...
      },
      {
        ...
        sessions: [
          ...
          { name: "Split squat, front foot elevated â€” 3Ã—8 each leg, 90s rest. LEFT leg forward: limit depth (FAI)." },
    ...
    days: [
      ...
      },
      {
        ...
        sessions: [
          ...
          { name: "Split squat, front foot elevated â€” 3Ã—8 each leg, 90s rest (progressed). LEFT leg forward: limit depth (FAI)." },
    ...
    days: [
      ...
      },
      {
        ...
        sessions: [
          ...
          { name: "Split squat, front foot elevated â€” 3Ã—8 (single 18lb DB goblet hold), 90s rest. LEFT leg forward: limit depth (FAI)." },
          { name: "Adductor slide â€” 3Ã—10" },
