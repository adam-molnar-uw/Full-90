...
function generateWeeks() {
  ...
  weeks.push({
    number: 6,
    phase: "Transition to Running",
    focus: "DELOAD WEEK. Reduce volume 40%, maintain intensity. Recovery before Phase 3. Hip mobility continues full volume.",
    progressionGate: "Can run 30 min with tempo blocks. Shuttles tolerated. Feeling FRESH. Ready for soccer-specific work.",
    days: [
      {
        day: "Monday",
        type: "conditioning",
        label: "Easy Bike (Deload)",
        hrTarget: "Z2",
        sessions: [
          { name: "20 min Z2 seated (active recovery only)", zone: "Z2" },
        ],
        notes: "DELOAD: No intervals. Easy spin only. BIKE CUE: knees track outward.",
        physio: ["Banded BW squats (mini band above knees, 2x10), then Movement Prep drills"],
      },
      {
        day: "Tuesday",
        type: "strength",
        ...
        sessions: [
          ...
          { name: "Copenhagen plank, FULL LEVER — 2x15s each side" },
          { name: "DB 1-leg RDL (CUE: knee over 4th/5th toe) — 2x10 (same weights as Week 5)." },
          { name: "Stabilization lunge (CUE: knee over 4th/5th toe) — 2x8 (2x25lb DB)." },
          { name: "Side lunges (CUE: knee over 4th/5th toe) — 2x10 (1x30lb DB goblet)." },
          { name: "Cable hip abduction — 2x12 each side." },
          { name: "Assisted Nordic curls — 3x4 (keep all 3 sets, building pattern)." },
          { name: "Pallof press — 2x10 each side." },
          { name: "Single-leg calf raises (CUE: knee over 4th/5th toe) 2x12 each, straight + bent knee." },
        ],
      ...
      { day: "Wednesday", type: "rest", label: "Rest + Daily Physio", sessions: [] },
      {
        day: "Thursday",
        type: "conditioning",
        label: "Short Run + Shuttles (Deload)",
        hrTarget: "Z3-4",
        sessions: [
          { name: "Banded BW squats (mini band above knees, 2x10), then Movement Prep drills" },
          { name: "10 min jog warm-up", zone: "Z2" },
          { name: "4x200m at 80% / jog back recovery (reduced from 8)", zone: "Z4" },
          { name: "4x lateral shuttle (5m each way) — ONLY if PTFJ allows.", zone: "Z3" },
          { name: "8 min jog cool-down", zone: "Z2" },
        ],
        notes: "DELOAD: half the sprint volume, keep the intensity.",
      },
      {
        day: "Friday",
        type: "strength",
        ...
        sessions: [
          ...
          { name: "Single leg hip thrust — 2x10 (1x30lb DB on lap)" },
          { name: "Cable hip abduction — 2x12 each side" },
        ],
      },
      {
        day: "Saturday",
        type: "conditioning",
        label: "Easy Tempo Run (Deload)",
        hrTarget: "Z2-3",
        sessions: [
          { name: "Banded BW squats (mini band above knees, 2x10), then Movement Prep drills" },
          { name: "20 min easy: 15 min Z2, 5 min Z3", zone: "Z2-3" },
        ],
        notes: "DELOAD: shorter than last week. You should feel fresh going into Phase 3.",
      },
      { day: "Sunday", type: "rest", label: "Full Rest — Phase Gate", sessions: [], notes: "Assess: ready for Phase 3? Check PTFJ, L hip ROM progress, overall fatigue. You should feel FRESH." },
    ],
  });
  // WEEK 7
  weeks.push({
    ...
    days: [
      ...
      },
      {
        ...
        sessions: [
          ...
          { name: "Plyometrics: split squat jumps (CUE: knee over 4th/5th toe) + lateral bounds (3Ã—8 each). LEFT leg forward on split squats: limit depth — progress as hip mobility improves." },
