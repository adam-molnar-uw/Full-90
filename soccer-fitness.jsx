...
function generateWeeks() {
    ...
    days: [
      { day: "Monday", type: "strength", label: "Home Strength — Activation + Stability",
        sessions: [
          ...
          { name: "2. Stabilization lunge — 3×8 (bodyweight). L ankle: focus on control." },
          { name: "3. Adductor slide (towel) — 3×10" },
          { name: "4. Single-leg hip thrust — 3×8 (bodyweight)" },
          { name: "5. Single-leg calf raises — 3×15 each, straight + bent knee (bodyweight, 3s eccentric). Bent-knee extra important on LEFT." },
        ],
        notes: "Activation/stability day at home. No Copenhagen yet — that starts Week 5 and needs 0/10 groin to introduce. Adductor slides are fine at 1–2/10 (proven tolerance). If groin is 3+/10, rest day.",
      },
      ...
      { day: "Thursday", type: "strength", label: "Gym Strength — Progressive Overload",
        sessions: [
          ...
          { name: "2. Goblet stabilization lunge — 3×8 (20lb DB). L ankle: control on every rep." },
          { name: "3. DB side lunges — 3×8 (2×20lb DB). LEFT: shallower depth (FAI)." },
          ...
          { name: "5. Single-leg hip thrust — 3×8 (20lb DB on hip)" },
          { name: "6. Single-leg calf raises — 3×12 each, straight + bent knee (20lb DB in hand, 3s eccentric)." },
        ],
        notes: "First gym session. Conservative loads — small bump from home 18lb to 20lb, focus on form in new environment. Cable hip abduction is the priority new exercise: directly targets the weak glute med that's causing your TFL to overwork. If gym unavailable, do home strength with 18lb DBs.",
      },
    ...
    days: [
      { day: "Monday", type: "strength", label: "Home Strength — Activation + Copenhagen Intro",
        sessions: [
          ...
          { name: "3. Stabilization lunge — 3×8 (single 18lb DB goblet hold)" },
          { name: "4. Adductor slide — 3×12" },
          { name: "5. Single-leg hip thrust — 3×8 (18lb DB on hip)" },
          { name: "6. Single-leg calf raises — 3×15 each, straight + bent knee (bodyweight, 3s eccentric)" },
        ],
        notes: "Copenhagen intro — keep it short lever and low duration. If you can't hold 15s, hold as long as you can. If groin nerve fires, drop Copenhagen and adductor slide. Lunge adds DB this week.",
      },
      ...
      { day: "Thursday", type: "strength", label: "Gym Strength — Load Progression",
        sessions: [
          ...
          { name: "2. Goblet stabilization lunge — 3×8 (25lb DB). L ankle: control on every rep." },
          { name: "3. DB side lunges — 3×10 (2×25lb DB). LEFT: shallower depth (FAI)." },
          { name: "4. Cable hip abduction — 3×12 each side (increase weight one notch from Wk 4)." },
          { name: "5. Single-leg hip thrust — 3×8 (25lb DB on hip)" },
          { name: "6. Single-leg calf raises — 3×12 each, straight + bent knee (25lb DB, 3s eccentric)." },
        ],
        notes: "5lb increase per exercise from Week 4. If any exercise felt shaky at Wk 4 weight, stay at that weight and increase reps instead. Form before load always. If gym unavailable, home strength with 18lb DBs.",
      },
    ...
    days: [
      { day: "Monday", type: "strength", label: "Home Strength — Activation + Copenhagen Progress",
        sessions: [
          ...
          { name: "3. Stabilization lunge — 3×8 (single 18lb DB goblet hold)" },
          { name: "4. Adductor slide — 3×12" },
          { name: "5. Single-leg hip thrust — 3×10 (18lb DB on hip)" },
          { name: "6. Single-leg calf raises — 3×15 each, straight + bent knee (bodyweight, 3s eccentric)" },
        ],
        notes: "Copenhagen hold time progressing — only if Wk 5 was comfortable. Don't rush to long lever yet, that's a Week 7+ consideration. Hip thrust reps increase to 10.",
      },
      ...
      { day: "Thursday", type: "strength", label: "Gym Strength — Phase 2 Peak",
        sessions: [
          { name: "GROIN SCREEN: 4 bodyweight side lunges each side." },
          { name: "1. DB 1-leg RDL — 3×12 (1×30lb DB, 5s eccentric). LEFT: torso parallel max (FAI). RIGHT: stop before sit-bone stretch." },
          { name: "2. Goblet stabilization lunge — 3×10 (30lb DB). L ankle: control on every rep." },
          { name: "3. DB side lunges — 3×10 (2×30lb DB). LEFT: shallower depth (FAI)." },
          { name: "4. Cable hip abduction — 3×15 each side (progress weight again)." },
          { name: "5. Single-leg hip thrust — 3×10 (30lb DB on hip)" },
          { name: "6. Single-leg calf raises — 3×12 each, straight + bent knee (30lb DB, 3s eccentric)." },
        ],
  ...
  weeks.push({
    ...
    days: [
      { day: "Monday", type: "strength", label: "Home Strength — Copenhagen Long Lever Test",
        ...
        notes: "Long lever Copenhagen is a significant jump. If short lever wasn't solid at 20s+, stay short lever. No shame in building more time before switching. Home day stays at 18lb — gym day is where loads progress.",
      },
      ...
      { day: "Thursday", type: "strength", label: "Gym Strength + Plyometric Intro",
        sessions: [
          ...
          { name: "2. Goblet stabilization lunge — 3×8 (35lb DB). L ankle: control on every rep." },
          { name: "3. DB side lunges — 3×12 (2×30lb DB). LEFT: shallower depth (FAI)." },
          { name: "4. Cable hip abduction — 3×15 each side (progress weight)." },
          { name: "5. Single-leg hip thrust — 3×8 (35lb DB on hip)" },
          { name: "6. Single-leg calf raises — 3×15 each, straight + bent knee (30lb DB, 3s eccentric)." },
  ...
  weeks.push({
    ...
    focus: "Extend match sim duration, add lateral bounds, progress Copenhagen, maintain strength loads",
    ...
    days: [
      ...
      { day: "Thursday", type: "strength", label: "Gym Strength + Lateral Bounds",
        sessions: [
          { name: "GROIN SCREEN: 4 bodyweight side lunges each side." },
          { name: "1. DB 1-leg RDL — 3×12 (1×35lb DB, 5s eccentric). LEFT: torso parallel max (FAI)." },
          { name: "2. Goblet stabilization lunge — 3×10 (35lb DB). L ankle: control on every rep." },
          { name: "3. DB side lunges — 3×10 (2×35lb DB). LEFT: shallower depth (FAI)." },
          { name: "4. Cable hip abduction — 3×12 each side (progress weight)." },
          { name: "5. Single-leg hip thrust — 3×10 (35lb DB on hip)" },
          { name: "6. Single-leg calf raises — 3×12 each, straight + bent knee (35lb DB, 3s eccentric)." },
  ...
  weeks.push({
    ...
    focus: "Peak training load week. Longest match sim. Strength to maintenance. Copenhagen peak.",
    ...
    days: [
      { day: "Monday", type: "strength", label: "Home Strength — Copenhagen Peak",
        ...
        notes: "Peak Copenhagen holds. After this week, strength shifts to maintenance for taper.",
      },
      ...
      { day: "Wednesday", type: "rest", label: "Rest + Daily Physio", sessions: [] },
      { day: "Thursday", type: "strength", label: "Gym Strength — Peak + Maintenance Transition",
        sessions: [
          { name: "GROIN SCREEN: 4 bodyweight side lunges each side." },
          { name: "1. DB 1-leg RDL — 3×10 (1×40lb DB, 5s eccentric). LEFT: torso parallel max (FAI). PEAK LOAD — do not increase further." },
          { name: "2. Goblet stabilization lunge — 3×8 (40lb DB). PEAK LOAD." },
          { name: "3. DB side lunges — 3×12 (2×35lb DB). LEFT: shallower depth (FAI). PEAK LOAD." },
          { name: "4. Cable hip abduction — 3×15 each side (hold at current weight)." },
          { name: "5. Single-leg hip thrust — 3×8 (40lb DB on hip). PEAK LOAD." },
          { name: "6. Single-leg calf raises — 3×15 each, straight + bent knee (35lb DB, 3s eccentric). PEAK LOAD." },
          { name: "7. Split squat jumps — 3×8" },
          { name: "8. Lateral bounds — 3×8 each side (if tolerated). L ankle braced." },
        ],
        notes: "Peak loads for the entire program. These weights are your maintenance targets for taper. Don't push beyond these — priority shifts to conditioning and match readiness. If gym unavailable, home strength at 18lb.",
      },
  ...
  weeks.push({
    ...
    focus: "Reduce volume, maintain intensity, sharpen for match day. Strength drops to 2 sets at Wk 8 loads.",
    ...
    days: [
      { day: "Monday", type: "strength", label: "Home Strength — Maintenance",
        sessions: [
          ...
          { name: "3. Stabilization lunge — 2×8 (single 18lb DB goblet hold)" },
          { name: "4. Single-leg hip thrust — 2×8 (18lb DB on hip)" },
          { name: "5. Single-leg calf raises — 2×12 each, straight + bent knee (bodyweight, 3s eccentric)" },
        ],
      ...
      { day: "Thursday", type: "strength", label: "Gym Strength — Taper Loads",
        sessions: [
          { name: "GROIN SCREEN: 4 bodyweight side lunges each side." },
          { name: "1. DB 1-leg RDL — 2×10 (1×35lb DB, 5s eccentric). LEFT: torso parallel max (FAI)." },
          { name: "2. Goblet stabilization lunge — 2×8 (35lb DB)." },
          { name: "3. DB side lunges — 2×10 (2×30lb DB). LEFT: shallower depth (FAI)." },
          { name: "4. Cable hip abduction — 2×12 each side (hold weight)." },
          { name: "5. Single-leg hip thrust — 2×8 (35lb DB on hip)" },
          { name: "6. Single-leg calf raises — 2×12 each, straight + bent knee (30lb DB, 3s eccentric)." },
