...
function generateWeeks() {
  ...
  weeks.push({
    number: 8,
    phase: "Soccer-Specific",
    focus: "Pass 30-min mixed Z2/Z3 gate test. Consolidate strength at new loads.",
    ...
    days: [
      {
        ...
        sessions: [
          ...
          { name: "2x15 min blocks: jog with sprint bursts every 2-3 min (10-15s)", zone: "mixed" },
          { name: "5 min half-time walk" },
        ],
        notes: "If gate test not yet passed, replace with: 20 min Z2 + 5 min Z3 + 2 min Z2. Monitor 5-hour PTFJ window.",
      },
      {
        day: "Tuesday",
        type: "strength",
        ...
        notes: "First session at 40lb stab lunges and RDLs. Monitor valgus carefully at new weight. Cable abduction bump from 15 to 17.5 if available.",
      },
      { day: "Wednesday", type: "rest", label: "Rest + Daily Physio", sessions: [] },
      {
        day: "Thursday",
        type: "conditioning",
        label: "Gate Test or RSA",
        hrTarget: "Z2-5",
        sessions: [
          { name: "IF GATE TEST: Movement Prep + isometric priming, then 20 min Z2 + 5 min Z3 + 2 min Z2. Tape-free. Monitor 5-hour PTFJ window.", zone: "Z2-3" },
          { name: "IF GATE PASSED: 10 min jog Z2, 3 sets of 6x20m sprint / 20s rest / 3 min between sets, agility circuit x6, 10 min cool-down", zone: "Z4-5" },
        ],
        notes: "Gate test is the priority this week. If not yet attempted, do it here. RSA only if gate is already passed.",
      },
      {
        day: "Friday",
        type: "conditioning",
        ...
        hrTarget: "Z1-2",
        sessions: [{ name: "25 min easy walk", zone: "Z1-2" }],
        notes: "Keep it genuinely easy. No bike (PTFJ aggravator).",
      },
      {
        day: "Saturday",
        type: "conditioning",
        ...
        hrTarget: "Z2-5",
        sessions: [
          { name: "Option A: Pickup game - come on as sub at 45 min to manage exposure" },
          { name: "Option B: Solo match sim - 2x20 min with mixed sprints, 5 min half-time" },
        ],
        notes: "Only attempt game play if gate test is passed. Ankle brace + PTFJ tape for first game (LaPrade protocol). H10 on for benchmark data.",
      },
      { day: "Sunday", type: "rest", label: "Full Rest", sessions: [] },
    ],
  });
  ...
  weeks.push({
    number: 9,
    phase: "Soccer-Specific",
    focus: "First pickup games post-gate. Progress strength. Build match tolerance.",
    progressionGate: "Can sustain 2x20 min match sim. Pickup game completed without flare. Average HR in game at 75-80% max.",
    days: [
      {
        day: "Monday",
        type: "conditioning",
        label: "Match Simulation - Extended",
        hrTarget: "Z2-5",
        sessions: [
          { name: "Movement Prep" },
          { name: "2x20 min blocks: jog with sprint bursts every 2 min (10-20s)", zone: "mixed" },
          { name: "5 min half-time walk" },
        ],
        notes: "Progression: longer blocks, more frequent sprints. Post-session: foam roll calves + hamstrings immediately and again at 2-3 hours.",
      },
      {
        day: "Tuesday",
        type: "strength",
        label: "Gym Strength + Upper Body",
        sessions: [
          { name: "1. Stab lunges - 2x40lb, 3x8. Consolidate at this weight." },
          ...
          { name: "9. Nordic curls - 3x4 eccentric (home day, partner holds ankles). Do early while fresh." },
          { name: "UPPER BODY: DB bench 35lb 3x8-10, DB shoulder press 40lb 3x8-10, cable rows 3x10, lat pulldown 3x10. 3s eccentric. Progress to 10-12 reps for hypertrophy." },
        ],
        notes: "Consolidate 40lb on lunges and RDLs before jumping to 45. Cable abduction progressing +2.5/week. No structured plyos this week if pickup game is scheduled - games are the plyometric stimulus.",
      },
      { day: "Wednesday", type: "rest", label: "Rest + Daily Physio", sessions: [] },
      {
        day: "Thursday",
        ...
        sessions: [
          ...
          { name: "Agility circuit x 6 reps" },
          { name: "10 min jog cool-down", zone: "Z2" },
        ],
        notes: "RSA training. Short rest between sprints simulates game demands. L ankle: stop agility if control deteriorates when fatigued. Tape/brace on for agility.",
      },
      {
        day: "Friday",
        type: "conditioning",
      ...
      },
      {
        ...
        hrTarget: "Z2-5",
        sessions: [
          { name: "60-75 min of game play or 2x25 min solo match sim" },
        ],
        notes: "Push duration from last week. Ankle brace every game. Wean PTFJ tape if Week 8 game was clean. H10 data: compare to last week.",
      },
      { day: "Sunday", type: "rest", label: "Full Rest", sessions: [] },
    ],
  });
  ...
  weeks.push({
    number: 10,
    phase: "Soccer-Specific",
    focus: "Hit strength targets. Peak conditioning volume. Multiple pickup games.",
    progressionGate: "Stab lunges at 2x45, RDL at 45, cable abduction at 22.5+. Can sustain 2x25 min match sim.",
    days: [
      {
        day: "Monday",
        type: "conditioning",
        label: "Match Simulation - Long",
        hrTarget: "Z2-5",
        sessions: [
          { name: "Movement Prep" },
          { name: "2x25 min blocks: jog with sprint bursts every 90s-2 min", zone: "mixed" },
          { name: "5 min half-time" },
        ],
        notes: "Approaching match duration. 55 min total mixed-intensity work.",
      },
      {
        day: "Tuesday",
        type: "strength",
        ...
        notes: "This is the peak strength week. Hit target weights on lunges and RDLs. If form breaks under 45lb (valgus), drop back to 40 and maintain. No structured plyos - pickup games provide reactive stimulus.",
      },
      { day: "Wednesday", type: "rest", label: "Rest + Daily Physio", sessions: [] },
      {
        day: "Thursday",
        ...
        sessions: [
          ...
          { name: "Agility circuit x 8 reps" },
          { name: "8 min jog cool-down", zone: "Z2" },
        ],
        notes: "Peak sprint volume. 4 sets instead of 3. Drop set 4 if crushed by set 3. L ankle: stop agility if control deteriorates. Tape/brace on.",
      },
      {
        day: "Friday",
        type: "conditioning",
      ...
      },
      {
        ...
        hrTarget: "Z2-5",
        sessions: [
          { name: "75+ min of game play or 2x30 min solo match sim" },
        ],
        notes: "Push toward full game duration. This is the fitness test. H10 data is your benchmark for match readiness.",
      },
      { day: "Sunday", type: "rest", label: "Full Rest", sessions: [] },
    ],
  });
  ...
  weeks.push({
    number: 11,
    phase: "Soccer-Specific",
    focus: "Maintain all targets. Functional test. Last heavy week before deload.",
    ...
    days: [
      {
        ...
        sessions: [
          { name: "Movement Prep" },
          { name: "2x30 min: jog with sprint bursts every 90s-2 min", zone: "mixed" },
          { name: "5 min half-time" },
        ],
        notes: "Hardest conditioning session. 65 min total. This is match-duration work.",
      },
      {
        day: "Tuesday",
        type: "strength",
        label: "Gym Strength - Maintain Targets + Functional Test",
        sessions: [
          ...
          { name: "FUNCTIONAL TEST: Single-leg mini squat under fatigue (after full circuit). Clean form without valgus collapse = PASS." },
          { name: "UPPER BODY: DB bench 37.5lb 3x10, DB shoulder press 40lb 3x10, cable rows 3x12, lat pulldown 3x12. Maintain." },
        ],
        notes: "Last heavy session before deload. Hit all targets. If functional test shows valgus, note which side and flag for Nick. Pickup games remain the primary stimulus - no structured plyos.",
      },
      { day: "Wednesday", type: "rest", label: "Rest + Daily Physio", sessions: [] },
      {
        day: "Thursday",
        ...
        notes: "Last peak RSA. Full volume. After this week, conditioning load drops.",
      },
      {
        day: "Friday",
        type: "conditioning",
      ...
      },
      {
        ...
        sessions: [
          ...
          { name: "Or 2x35 min solo match sim" },
        ],
        notes: "Play as close to full game duration as possible. Last heavy game week.",
      },
      { day: "Sunday", type: "rest", label: "Full Rest", sessions: [] },
    ],
  });
  ...
  weeks.push({
    ...
    focus: "Deload: volume -40%, maintain intensity. Recovery before taper.",
    ...
    days: [
      {
        ...
        sessions: [
          { name: "Movement Prep" },
          { name: "2x15 min match sim (reduced from 2x30)", zone: "mixed" },
        ],
      ...
      },
      {
        ...
        notes: "Same weights, fewer sets. The goal is maintaining neural patterns without accumulating fatigue. Fitness supercompensates during deload.",
      },
      { day: "Wednesday", type: "rest", label: "Rest + Daily Physio", sessions: [] },
      {
        day: "Thursday",
        ...
        notes: "Reduced from 4 sets to 2. More recovery between sprints. Maintaining speed without fatigue accumulation.",
      },
      {
        day: "Friday",
        type: "rest",
      ...
      },
      {
        ...
        notes: "Play smart, not hard. Dress rehearsal intensity. Save something.",
      },
      { day: "Sunday", type: "rest", label: "Full Rest", sessions: [] },
    ],
  });
  ...
  weeks.push({
    ...
    days: [
      ...
      },
      {
        ...
        notes: "Keeping movement patterns alive without creating any fatigue. You are not getting weaker - you are getting faster.",
      },
      { day: "Wednesday", type: "rest", label: "Rest + Daily Physio", sessions: [] },
      {
        day: "Thursday",
        ...
        notes: "Short, sharp. You should feel fast. If you don't feel fast, rest more between sprints.",
      },
      {
        day: "Friday",
        type: "rest",
