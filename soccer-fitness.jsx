...
const PROGRAM_DATA = {
  ...
  hrZones: [
    { zone: 1, name: "Recovery", bpm: "121â€”133", pct: "50â€”60%", desc: "Very easy, walking pace" },
    { zone: 2, name: "Aerobic Base", bpm: "133â€”145", pct: "60â€”70%", desc: "Conversational, sustainable" },
    { zone: 3, name: "Tempo", bpm: "145â€”158", pct: "70â€”80%", desc: "Comfortably hard, breathing heavier" },
    { zone: 4, name: "Threshold", bpm: "158â€”170", pct: "80â€”90%", desc: "Hard, short sentences only" },
    { zone: 5, name: "Max", bpm: "170â€”182", pct: "90â€”100%", desc: "All-out sprint effort" },
  ],
  dailyPhysio: [
  ...
  weeks.push({
    ...
    days: [
      ...
      },
      {
        ...
        sessions: [
          { name: "Side plank â€” 3Ã—30s each side (physio Rx for AdMag)" },
          { name: "DB 1-leg RDL â€” 3Ã—10 (single 18lb DB, 5s eccentric). LEFT: torso parallel max (FAI). RIGHT: sit-bone limit." },
          { name: "Split squat, front foot elevated â€” 3Ã—8 each leg, 90s rest (18lb DB each hand). LEFT leg forward: limit depth (FAI)." },
          { name: "Adductor slide â€” 3Ã—8" },
          { name: "Side lunges â€” 3Ã—8 (progressed from 6). LEFT: shallower depth (FAI)." },
        ],
        notes: "Split squat replaces stabilization lunge â€" targets adductor magnus from lengthened position. Adduction plank REMOVED this week â€" replaced by side plank while AdMag calms down. Scaffold: side plank (Wk 2â€"3) â€" Copenhagen short lever (Wk 4) â€" full Copenhagen (Wk 5+). LEFT RDL depth limit is permanent â€" torso parallel, no deeper.",
      },
      {
        day: "Wednesday",
        type: "rest",
      ...
      },
      {
        ...
        sessions: [
          ...
          { name: "Single-leg calf raises â€” 3Ã—15 each, straight + bent knee (18lb DB, 3s eccentric. Hold DB in one hand, wall for balance)" },
        ],
      },
      {
        day: "Saturday",
    ...
    days: [
      {
        day: "Monday",
        type: "conditioning",
        label: "Running Interval Progression",
        hrTarget: "Z4â€“5",
        sessions: [
          { name: "Movement Prep + 5 min jog warm-up", zone: "Z2" },
          { name: "10Ã—10s running sprints / 50s walk recovery. Backup: standing bike sprints at same HR zones if no track access", zone: "Z5" },
          { name: "Rest 3 min, then 3Ã—30s hard efforts / 90s recovery", zone: "Z4" },
          { name: "Cool-down: 5 min", zone: "Z1" },
        ],
        notes: "Running is now primary for intervals â€” physio cleared walk/jog/sprint. First introduction of 30s efforts. If no track access, use standing bike sprints at same HR zones. These build lactate tolerance needed for match play.",
        physio: ["Movement Prep drills. SKIP Carioca if groin nerve is still active."],
      },
      {
        day: "Tuesday",
        ...
        sessions: [
          ...
          { name: "Split squat, front foot elevated â€” 3Ã—8 each leg, 90s rest (single 18lb DB goblet hold). LEFT leg forward: limit depth (FAI)." },
      ...
      { day: "Wednesday", type: "rest", label: "Rest + Daily Physio", sessions: [] },
      {
        ...
        hrTarget: "Z2",
        sessions: [
          { name: "35 min Z2 steady state â€” seated bike, elliptical, or easy jog", zone: "Z2" },
        ],
        notes: "Seated bike already cleared (Week 1). This is pure aerobic base building â€” keep it easy and conversational. Bike preferred for recovery between hard running days, but easy jog works too.",
        physio: ["Movement Prep drills. SKIP Carioca if groin nerve is still active."],
      },
      {
        day: "Friday",
        ...
        label: "Lateral Chain + Hip Thrust",
        sessions: [
          { name: "Full strength circuit (same as Tuesday (includes split squat + side plank) + single leg hip thrust 3Ã—8 bodyweight)" },
          { name: "Single-leg calf raises â€” 3Ã—15 each, straight + bent knee (18lb DB, 3s eccentric. Hold DB in one hand, wall for balance)" },
        ],
  ...
  weeks.push({
    ...
    days: [
      ...
      },
      {
        ...
        label: "Lateral Chain Strength",
        sessions: [
          { name: "Copenhagen plank, short lever (knee on bench) â€" 3Ã—15â€"20s each side. Progression gate: zero groin/AdMag complaints for 1 week before advancing to full lever." },
          { name: "Side plank â€” 3Ã—30s each side (physio Rx for AdMag)" },
          { name: "DB 1-leg RDL â€” 3Ã—12 (18lb each hand = 36lb total, 5s eccentric). LEFT: torso parallel max (FAI)." },
          { name: "Split squat, front foot elevated â€” 3Ã—8 (18lb DB each hand = 36lb total), 90s rest. LEFT leg forward: limit depth (FAI)." },
          { name: "Adductor slide â€” 3Ã—10" },
  ...
  weeks.push({
    ...
    days: [
      ...
      },
      {
        ...
        sessions: [
          { name: "Copenhagen plank, full lever (foot on bench) â€" 3Ã—45â€"60s. Returned from short lever progression." },
          { name: "Side plank â€” 3Ã—30s each side (physio Rx for AdMag)" },
        ...
        {view === "zones" && (
          <div style={{ paddingTop: 20 }}>
            ...
            <p style={{ fontSize: 12, color: "#64748b", marginBottom: 16 }}>
                <p style={{ fontSize: 12, color: "#64748b", marginBottom: 4 }}>Karvonen method â€” locked Feb 16</p>
                <p style={{ fontSize: 11, color: "#475569", marginBottom: 16 }}>Max 182 â€” Rest 60 â€” HRR 122</p>
            </p>
              ...
              return (
                <div key={z.zone} style={{
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: 14, color: "#f8fafc", fontFamily: "'DM Mono', monospace" }}>{z.bpm} bpm</div>
                    <div style={{ fontSize: 11, color: "#94a3b8" }}>{z.pct} of max HR</div>
            ...
            <div style={{
              ...
              <p style={{ fontSize: 12, color: "#4ade80", margin: 0, fontWeight: 600 }}>âœ… H10 active â€” Karvonen zones locked</p>
              <div style={{ fontSize: 12, color: "#6b9e7e", margin: "6px 0 0", lineHeight: 1.8 }}>
                <div>Z1: 121â€”133 bpm â€” recovery walks</div>
                <div>Z2: 133â€”145 bpm â€” aerobic base, easy jog</div>
                <div>Z3: 145â€”158 bpm â€” tempo, match-pace jog</div>
                <div>Z4: 158â€”170 bpm â€” threshold, hard intervals</div>
                <div>Z5: 170â€”182 bpm â€” max sprints</div>
              </div>
            <div style={{
              marginTop: 16, padding: 14, borderRadius: 10,
