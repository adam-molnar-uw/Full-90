  ...
  weeks.push({
    ...
    days: [
      ...
      },
      {
        ...
        physio: ["Movement Prep: Ankle hops, A-skip, B-skip, Carioca (3×50ft each, 90s rest). CUE: L ankle control on all landings. SKIP Carioca if groin nerve is active — the crossover loads adduction + rotation."],
        sessions: [
      ...
      },
      {
        ...
        physio: ["Movement Prep: Ankle hops, A-skip, B-skip, Carioca (3×50ft each, 90s rest) — do these BEFORE the jog as warm-up. Keep shoes + orthotics on for all drills. SKIP Carioca if groin nerve is active."],
      },
      {
        day: "Sunday",
        type: "rest",
  ...
  weeks.push({
    ...
    days: [
      ...
      },
      {
        ...
        sessions: [
          { name: "Adduction plank, long lever — 3×50–60s (progress hold time). MONITOR: skip or reduce if groin nerve is still active." },
  ...
  weeks.push({
    ...
    days: [
      ...
      },
      {
        ...
        sessions: [
          { name: "Adduction plank — 3×60s. MONITOR: skip or reduce if groin nerve is still active." },
    ...
    days: [
      ...
      },
      {
        ...
        sessions: [
          ...
          { name: "Add: split squat jumps 3×6 (low height, controlled landing) — SKIP if PTFJ reacts. Land softly through midfoot. Monitor L ankle stability on every landing — if it rolls or wobbles, reduce height. LEFT leg forward: don't drop into deep hip flexion on landing (FAI)." },
    ...
    days: [
      ...
      },
      {
        ...
        sessions: [
          ...
          { name: "Split squat jumps 3×8 (if tolerated) — monitor L ankle control on landing. LEFT leg forward: don't drop into deep hip flexion (FAI)." },
    ...
    days: [
      ...
      },
      {
        ...
        sessions: [
          ...
          { name: "Plyometrics: split squat jumps + lateral bounds (3×8 each). LEFT leg forward on split squats: limit depth (FAI)." },
    ...
    days: [
      ...
      },
      {
        ...
        sessions: [
          ...
          { name: "Plyometrics: 2×6 each. LEFT leg forward on split squats: limit depth (FAI)." },
