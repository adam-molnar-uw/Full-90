...
const PROGRAM_DATA = {
  meta: {
    ...
    phases: [
      ...
      { name: "Soccer-Specific", weeks: [7, 8, 9, 10, 11], color: "#c2255c" },
      { name: "Match Prep & Taper", weeks: [12, 13, 14], color: "#364fc7" },
    ],
  },
  hrZones: [
...
function generateWeeks() {
    ...
    days: [
      ...
      },
      {
        ...
        sessions: [
          ...
          { name: "DB 1-leg RDL â€” 3Ã—8 (single 18lb DB, 5s eccentric) â€” LEFT SIDE: stop at torso parallel (hip restriction + sit-bone). RIGHT SIDE: stop before sit-bone stretch.", zone: "Controlled" },
          ...
          { name: "Side lunges â€” 3Ã—6. LEFT SIDE: don't sink as deep (hip restriction â€” deep flexion + adduction compresses anterior hip)." },
        ],
      ...
      },
      {
        ...
        sessions: [
          ...
          { name: "2. DB 1-leg RDL â€” 3Ã—8 (single 18lb DB, 5s eccentric) â€” LEFT: torso parallel max (hip restriction). RIGHT: stop before sit-bone stretch." },
          { name: "3. Side lunges â€” 3Ã—6 BODYWEIGHT ONLY. LEFT: shallower depth (hip restriction)." },
        ...
        notes: "Exercise order is intentional â€” stabilization lunge is the groin screen for the adductor exercises at the end. If lunge fires the groin, do exercises 2â€“5 only and skip 6â€“7. LEFT RDL depth limit is permanent (hip restriction) â€” don't test it.",
      },
      {
        day: "Saturday",
        type: "conditioning",
    ...
    days: [
      ...
      },
      {
        ...
        sessions: [
          ...
          { name: "DB 1-leg RDL â€” 3Ã—10 (single 18lb DB, 5s eccentric). LEFT: torso parallel max (hip restriction). RIGHT: sit-bone limit." },
          { name: "Stabilization lunge â€” 3Ã—6" },
          { name: "Adductor slide â€” 3Ã—8" },
          { name: "Side lunges â€” 3Ã—8 (progressed from 6). LEFT: shallower depth (hip restriction)." },
        ],
      ...
      },
      {
        ...
        sessions: [
          ...
          { name: "DB 1-leg RDL â€” 3Ã—10 (single 18lb DB, 5s eccentric). LEFT: torso parallel max (hip restriction)." },
          { name: "Stabilization lunge â€” 3Ã—6" },
          { name: "Adductor slide â€” 3Ã—8" },
          { name: "Side lunges â€” 3Ã—8. LEFT: shallower depth (hip restriction)." },
  ...
  weeks.push({
    ...
    progressionGate: "Can tolerate 10+ min seated bike. Jog 15 min continuous without PTFJ or sit-bone flare. LEFT hip tolerating RDL/side lunge at parallel depth (hip restriction stable). Groin nerve resolved. Ready for Phase 2.",
    days: [
      {
        day: "Monday",
        type: "conditioning",
      ...
      },
      {
        ...
        sessions: [
          ...
          { name: "DB 1-leg RDL â€” 3Ã—10 (single 18lb DB, 5s eccentric â€” progress depth on RIGHT if sit-bone allows. LEFT: torso parallel max, hip restriction)" },
          { name: "Stabilization lunge â€” 3Ã—8 (progressed)" },
          { name: "Adductor slide â€” 3Ã—10" },
          { name: "Side lunges â€” 3Ã—8 with single 18lb DB goblet hold. LEFT: shallower depth (hip restriction)." },
          { name: "Single-leg calf raises â€” 3Ã—15 each, straight + bent knee (bodyweight, 3s eccentric)" },
        ],
      },
  ...
  weeks.push({
    ...
    days: [
      ...
      },
      {
        ...
        sessions: [
          { name: "Adduction plank â€” 3Ã—60s" },
          { name: "DB 1-leg RDL â€” 3Ã—12 (18lb each hand = 36lb total, 5s eccentric). LEFT: torso parallel max (hip restriction)." },
          { name: "Stabilization lunge â€” 3Ã—8 (single 18lb DB goblet hold)" },
          { name: "Adductor slide â€” 3Ã—10" },
          { name: "Side lunges â€” 3Ã—8 with 18lb DB each hand. LEFT: shallower depth (hip restriction)." },
        ],
      },
      { day: "Wednesday", type: "rest", label: "Rest + Daily Physio", sessions: [] },
      {
    ...
    days: [
      ...
      },
      {
        ...
        sessions: [
          ...
          { name: "DB 1-leg RDL â€” 3Ã—12 (18lb each hand = 36lb total, 5s eccentric â€” home max). LEFT: torso parallel max (hip restriction)." },
          { name: "Stabilization lunge â€” 3Ã—8 (single 18lb DB goblet hold)" },
          { name: "Adductor slide â€” 3Ã—12" },
          { name: "Side lunges â€” 3Ã—10 with 18lb DB each hand (home max). LEFT: shallower depth (hip restriction)." },
  ...
  weeks.push({
    ...
    progressionGate: "Can sustain 30 min of mixed-intensity running. Lateral movements tolerated. LEFT hip stable under plyometric landing (hip restriction not aggravated by split squat jumps).",
    days: [
      {
        day: "Monday",
        type: "conditioning",
      ...
      },
      {
        ...
        sessions: [
          ...
          { name: "Add: split squat jumps 3Ã—6 (low height, controlled landing) â€” SKIP if PTFJ reacts. Land softly through midfoot. Monitor L ankle stability on every landing â€” if it rolls or wobbles, reduce height. LEFT leg forward: don't drop into deep hip flexion on landing (hip restriction)." },
          ...
          { name: "UPPER BODY (after lower body): DB bench press 3x8, DB shoulder press 3x8, cable rows 3x10, lat pulldown 3x10. Progress load when clean. 3s eccentric." },
        ],
  ...
  weeks.push({
    number: 8,
    phase: "Soccer-Specific",
    focus: "Pass gate test. Consolidate strength at new loads. No sprints or agility yet.",
    progressionGate: "Gate test passed: 20 min Z2 + 5 min Z3 + 2 min Z2, tape-free, clean 5-hour PTFJ window.",
    days: [
      {
        day: "Monday",
        type: "conditioning",
        label: "Extended Z2 Run",
        hrTarget: "Z2",
        sessions: [
          { name: "Movement Prep (skip hops/Cariocas if PTFJ >0)" },
          { name: "25 min continuous jog at Z2", zone: "Z2" },
        ],
        notes: "Straight-line only. Building toward gate test. Post-run: foam roll calves + hamstrings immediately and at 2-3 hours. Monitor 5-hour PTFJ window.",
      },
      {
        day: "Tuesday",
        type: "strength",
        label: "Gym Strength + Upper Body",
        sessions: [
          { name: "1. Stab lunges - 2x40lb, 3x8. Knees over 4th/5th toe." },
          { name: "2. Single-leg RDL - 40lb, 3x8. LEFT: torso parallel max (hip restriction)." },
          { name: "3. Cable abduction - 17.5lb, 3x12." },
          { name: "4. Side plank hip abduction - 3x30s each." },
          { name: "5. Pallof press - 17lb, 3x10 each." },
          { name: "6. Copenhagen long lever - 3x30s." },
          { name: "7. Hollow hold - 3x30s." },
          { name: "8. Calf raises - 20lb R 3x12, 15lb L 3x12 (wall touch, terminate on form breakdown). Skip L if ankle >1/10." },
          { name: "UPPER BODY: DB bench 30-35lb 3x8, DB shoulder press 35-40lb 3x8, cable rows 3x10, lat pulldown 3x10. 3s eccentric." },
        ],
        notes: "First session at 40lb stab lunges and RDLs. Monitor valgus carefully at new weight.",
      },
      { day: "Wednesday", type: "rest", label: "Rest + Daily Physio", sessions: [] },
      {
        day: "Thursday",
        ...
        hrTarget: "Z2-3",
        sessions: [
          { name: "Isometric priming: eversions + calf holds (45-min analgesic window)" },
          { name: "Movement Prep (A-skip, B-skip only)" },
          { name: "GATE TEST: 20 min Z2 + 5 min Z3 + 2 min Z2. Tape-free. Straight-line only.", zone: "Z2-3" },
        ],
        notes: "This is the session. Orthotics in, no PTFJ tape. If Z3 block feels unsustainable, drop back to Z2 and try again next week. Monitor 5-hour PTFJ window post-run - must stay clean to pass. Foam roll immediately after.",
      },
      {
        day: "Friday",
        type: "rest",
        label: "Rest - PTFJ Monitoring Window",
        sessions: [],
        notes: "Gate test was yesterday. Monitor PTFJ through today. If 5-hour window was clean and you wake Saturday at 0/10, the gate is PASSED.",
      },
      {
        day: "Saturday",
        type: "strength",
        label: "Light Gym Session",
        sessions: [
          { name: "Abbreviated circuit: stab lunges 2x40lb 2x8, RDL 40lb 2x8, cable abduction 17.5lb 2x12, Pallof 2x10." },
          { name: "UPPER BODY: DB bench 3x8, DB shoulder press 3x8. Progress load if Tuesday was clean." },
        ],
        notes: "Lighter volume. Consolidating new weights. Save legs for next week's progression.",
      },
      { day: "Sunday", type: "rest", label: "Full Rest", sessions: [] },
    ],
  });
  ...
  weeks.push({
    number: 9,
    phase: "Soccer-Specific",
    focus: "Introduce linear sprints. First pickup game (sub at 45 min). Extend running duration.",
    progressionGate: "Tolerates linear sprints without PTFJ flare. First game completed without injury. Can sustain 30 min mixed-intensity running.",
    days: [
      {
        day: "Monday",
        type: "conditioning",
        label: "Tempo Run + Sprint Introduction",
        hrTarget: "Z2-4",
        sessions: [
          { name: "Movement Prep + isometric priming" },
          { name: "10 min Z2 jog", zone: "Z2" },
          { name: "5 min Z3", zone: "Z3" },
          { name: "6x40m strides at 75-80% (NOT all-out). Walk back recovery.", zone: "Z4" },
          { name: "5 min Z2 cool-down", zone: "Z2" },
        ],
        notes: "First sprint exposure. Strides, not sprints - controlled acceleration, not max effort. Monitor L ankle on each stride. Orthotics in. Foam roll immediately after and at 2-3 hours. 5-hour PTFJ window must be clean before progressing Thursday.",
      },
      {
        day: "Tuesday",
        type: "strength",
        label: "Gym Strength + Upper Body",
        sessions: [
          { name: "1. Stab lunges - 2x40lb, 3x8. Consolidate." },
          { name: "2. Single-leg RDL - 40lb, 3x8." },
          { name: "3. Cable abduction - 20lb, 3x12." },
          { name: "4. Side plank hip abduction - 3x35s each." },
          { name: "5. Pallof press - 17lb, 3x10 each." },
          { name: "6. Copenhagen long lever - 3x35s." },
          { name: "7. Hollow hold - 3x30s." },
          { name: "8. Calf raises - 20lb R 3x12, 15-20lb L 3x12 (progress L only if Nick clears). Wall touch mandatory." },
          { name: "UPPER BODY: DB bench 35lb 3x8-10, DB shoulder press 40lb 3x8-10, cable rows 3x10, lat pulldown 3x10. 3s eccentric." },
        ],
        notes: "Consolidate 40lb on lunges and RDLs. Cable abduction +2.5/week. No plyos this week - strides Monday and game Saturday are enough reactive load.",
      },
      { day: "Wednesday", type: "rest", label: "Rest + Daily Physio", sessions: [] },
      {
        day: "Thursday",
        type: "conditioning",
        label: "Sprint Progression",
        hrTarget: "Z4-5",
        sessions: [
          { name: "Movement Prep + isometric priming" },
          { name: "10 min Z2 jog", zone: "Z2" },
          { name: "8x40m sprints at 85% effort. Walk back recovery.", zone: "Z4-5" },
          { name: "3 min rest" },
          { name: "4x20m sprints at 90% with 30s rest between", zone: "Z5" },
          { name: "8 min jog cool-down", zone: "Z2" },
        ],
        notes: "Only do this if Monday strides had clean 5-hour window. Building from strides to actual sprints. The 20m set introduces short-rest repeated sprints. Still straight-line only - no direction changes yet.",
      },
      {
        day: "Friday",
        type: "conditioning",
        ...
        hrTarget: "Z1-2",
        sessions: [{ name: "20 min easy walk", zone: "Z1-2" }],
        notes: "Legs need to be fresh for first game tomorrow.",
      },
      {
        day: "Saturday",
        type: "conditioning",
        label: "FIRST PICKUP GAME",
        hrTarget: "Z2-5",
        sessions: [
          { name: "Full warm-up: Movement Prep + isometric priming + 5 min jog" },
          { name: "Come on as substitute at 45 min mark" },
          { name: "Target: 30-45 min of game play" },
        ],
        notes: "This is a huge milestone. L ankle brace ON. PTFJ tape ON (LaPrade protocol - first game, full protection). Orthotics in boots. H10 on. Come on as sub to manage exposure. If anything flares, come off. Post-game: foam roll immediately. Monitor 5-hour PTFJ window. The data from this session is your most important benchmark.",
      },
      { day: "Sunday", type: "rest", label: "Full Rest - Post-Game Recovery", sessions: [], notes: "Assess: how did the game feel? PTFJ score? Ankle? Any new issues? This data determines Week 10 planning." },
    ],
  });
  ...
  weeks.push({
    number: 10,
    phase: "Soccer-Specific",
    focus: "Add agility and direction changes. Extend game duration. Progress to target weights.",
    progressionGate: "Tolerates multi-directional movement. Can play 60+ min. Stab lunges at 2x45.",
    days: [
      {
        day: "Monday",
        type: "conditioning",
        label: "Agility Introduction + Sprints",
        hrTarget: "Z4-5",
        sessions: [
          { name: "Movement Prep + isometric priming" },
          { name: "10 min Z2 jog", zone: "Z2" },
          { name: "6x40m sprints at 90%, walk back", zone: "Z5" },
          { name: "3 min rest" },
          { name: "AGILITY INTRO: 4x(forward sprint 10m, lateral shuffle 5m, backpedal 10m, sprint 10m). Low intensity, focus on mechanics.", zone: "Z3-4" },
          { name: "8 min jog cool-down", zone: "Z2" },
        ],
        notes: "First multi-directional work. Lateral shuffle only - no sharp cutting yet. L ankle: control every direction change. Tape/brace on. If ankle feels sloppy at any point, stop agility and jog out. Foam roll immediately after.",
      },
      {
        day: "Tuesday",
        type: "strength",
        label: "Gym Strength - Target Weights + Upper Body",
        sessions: [
          { name: "1. Stab lunges - 2x45lb, 3x8. TARGET WEIGHT. Knees over 4th/5th toe." },
          { name: "2. Single-leg RDL - 45lb, 3x8. TARGET WEIGHT. LEFT: torso parallel max." },
          { name: "3. Cable abduction - 22.5lb, 3x12." },
          { name: "4. Side plank hip abduction - 3x40s each." },
          { name: "5. Pallof press - 20lb, 3x10 each." },
          { name: "6. Copenhagen long lever - 3x40s." },
          { name: "7. Hollow hold - 3x30s." },
          { name: "8. Calf raises - 20lb R 3x12, 20lb L 3x12 (if Nick has cleared). Wall touch mandatory." },
          { name: "9. Nordic curls - 3x4-5 eccentric. Quality over volume." },
          { name: "UPPER BODY: DB bench 35-37.5lb 3x10, DB shoulder press 40lb 3x10, cable rows 3x12, lat pulldown 3x12. 3s eccentric." },
        ],
        notes: "Peak strength week. Hit target weights. If valgus appears under 45lb, drop to 40 and maintain. No structured plyos - game Saturday is the reactive stimulus.",
      },
      { day: "Wednesday", type: "rest", label: "Rest + Daily Physio", sessions: [] },
      {
        day: "Thursday",
        type: "conditioning",
        label: "RSA + Agility Progression",
        hrTarget: "Z4-5",
        sessions: [
          { name: "Movement Prep + isometric priming" },
          { name: "10 min jog", zone: "Z2" },
          { name: "3 sets of: 6x20m sprint / 20s rest / 3 min between sets", zone: "Z5" },
          { name: "Agility circuit x 6 reps (same pattern as Monday, higher intensity)", zone: "Z4-5" },
          { name: "8 min jog cool-down", zone: "Z2" },
        ],
        notes: "First proper RSA session. Short rest between sprints simulates game demands. Only progress agility intensity if Monday session was clean. L ankle: stop if control deteriorates when fatigued. Tape/brace on.",
      },
      {
        day: "Friday",
        type: "conditioning",
        label: "Active Recovery",
        hrTarget: "Z1",
        sessions: [{ name: "20 min easy walk", zone: "Z1" }],
        notes: "Fresh legs for tomorrow's game.",
      },
      {
        day: "Saturday",
        type: "conditioning",
        label: "Pickup Game - Extended",
        hrTarget: "Z2-5",
        sessions: [
          { name: "Full warm-up: Movement Prep + isometric priming" },
          { name: "Target: 60-75 min of game play. Start from the beginning if possible." },
        ],
        notes: "Push duration from last week. Ankle brace every game. Wean PTFJ tape if Week 9 game was clean (try without, have tape ready on sideline). H10: compare to Week 9 data.",
      },
      { day: "Sunday", type: "rest", label: "Full Rest", sessions: [] },
    ],
  });
  ...
  weeks.push({
    number: 11,
    phase: "Soccer-Specific",
    focus: "Peak week. Maintain all targets. Full agility. Longest game. Functional test.",
    progressionGate: "All Week 10 targets maintained. Clean single-leg mini squat under fatigue without valgus. Ready for deload.",
    days: [
      {
        day: "Monday",
        type: "conditioning",
        label: "Match Simulation - Peak",
        hrTarget: "Z2-5",
        sessions: [
          { name: "Movement Prep + isometric priming" },
          { name: "2x25 min: jog with sprint bursts every 90s-2 min", zone: "mixed" },
          { name: "5 min half-time" },
        ],
        notes: "Longest match sim. 55 min total mixed-intensity work. This is the conditioning test.",
      },
      {
        day: "Tuesday",
        type: "strength",
        label: "Maintain Targets + Functional Test + Upper Body",
        sessions: [
          { name: "1. Stab lunges - 2x45lb, 3x8. Maintain." },
          { name: "2. Single-leg RDL - 45lb, 3x8. Maintain." },
          { name: "3. Cable abduction - 25lb, 3x12. TARGET." },
          { name: "4. Side plank hip abduction - 3x45s each with mini band. TARGET." },
          { name: "5. Pallof press - 20lb, 3x10 each." },
          { name: "6. Copenhagen long lever - 3x45s. TARGET." },
          { name: "7. Calf raises - 20lb 3x12 both sides. TARGET (L gated by Nick)." },
          { name: "8. Nordic curls - 3x5 eccentric, full range. TARGET." },
          { name: "FUNCTIONAL TEST: Single-leg mini squat under fatigue (after full circuit). Clean form without valgus = PASS." },
          { name: "UPPER BODY: DB bench 37.5lb 3x10, DB shoulder press 40lb 3x10, cable rows 3x12, lat pulldown 3x12. Maintain." },
        ],
        notes: "Last heavy session before deload. Hit all targets. If functional test shows valgus, note which side and flag for Nick.",
      },
      { day: "Wednesday", type: "rest", label: "Rest + Daily Physio", sessions: [] },
      {
        day: "Thursday",
        type: "conditioning",
        label: "Peak RSA + Full Agility",
        hrTarget: "Z4-5",
        sessions: [
          { name: "Movement Prep + isometric priming" },
          { name: "10 min jog", zone: "Z2" },
          { name: "4 sets of: 6x20m sprint / 20s rest / 3 min between sets", zone: "Z5" },
          { name: "Agility circuit x 8 reps", zone: "Z4-5" },
          { name: "8 min jog cool-down", zone: "Z2" },
        ],
        notes: "Peak sprint and agility volume. 4 RSA sets. Drop set 4 if crushed by set 3. L ankle: stop agility if control deteriorates. Tape/brace on. Last peak conditioning session.",
      },
      {
        day: "Friday",
        type: "conditioning",
      ...
      },
      {
        day: "Saturday",
        type: "conditioning",
        label: "Pickup Game - Full Duration",
        hrTarget: "Z2-5",
        sessions: [
          { name: "Full pickup game aiming for 75-90 min" },
          { name: "Or 2x30 min solo match sim" },
        ],
        notes: "Play as close to full game duration as possible. Last heavy game week. This is the fitness test. H10 data is your match-readiness benchmark.",
      },
      { day: "Sunday", type: "rest", label: "Full Rest", sessions: [] },
    ],
  });
  ...
  weeks.push({
    ...
    focus: "Deload: volume -40%, maintain intensity. Let the body supercompensate.",
    progressionGate: "Feeling fresher, not more fatigued. Resting HR stable or dropping. PTFJ at 0/10.",
    days: [
      {
        day: "Monday",
        type: "conditioning",
        ...
        sessions: [
          { name: "Movement Prep" },
          { name: "2x15 min match sim (reduced from 2x25)", zone: "mixed" },
        ],
        notes: "Volume drops but intensity stays. You should feel faster and sharper than last week.",
      },
      {
        day: "Tuesday",
        type: "strength",
        label: "Gym Strength - Deload (2 sets, same weights)",
        sessions: [
          { name: "1. Stab lunges - 2x45lb, 2x8 (2 sets, not 3)." },
          { name: "2. Single-leg RDL - 45lb, 2x8." },
          { name: "3. Cable abduction - 25lb, 2x12." },
          { name: "4. Side plank hip abduction - 2x45s each with mini band." },
          { name: "5. Copenhagen long lever - 2x45s." },
          { name: "6. Calf raises - 20lb 2x12 both sides." },
          { name: "7. Nordic curls - 2x5 eccentric." },
          { name: "UPPER BODY: DB bench 2x10, DB shoulder press 2x10, cable rows 2x10, lat pulldown 2x10. Same weights, 2 sets." },
        ],
        notes: "Same weights, fewer sets. Maintaining neural patterns without accumulating fatigue. Fitness supercompensates during deload - you are not getting weaker.",
      },
      { day: "Wednesday", type: "rest", label: "Rest + Daily Physio", sessions: [] },
      {
        day: "Thursday",
        ...
        sessions: [
          { name: "Movement Prep" },
          { name: "10 min jog", zone: "Z2" },
          { name: "2 sets of: 6x20m sprint / 25s rest / 3 min between sets", zone: "Z5" },
          { name: "Light agility circuit x 4" },
          { name: "10 min jog cool-down", zone: "Z2" },
        ],
        notes: "Reduced from 4 sets to 2. More recovery between sprints. Maintaining speed without fatigue.",
      },
      {
        day: "Friday",
        type: "rest",
        label: "Rest or Light Walk",
        sessions: [{ name: "Optional: 15 min walk", zone: "Z1" }],
      },
      {
        day: "Saturday",
        type: "conditioning",
        label: "Pickup Game - 85%",
        hrTarget: "Z2-5",
        sessions: [{ name: "45-60 min game at 85% effort" }],
        notes: "Play smart, not hard. Dress rehearsal intensity.",
      },
      { day: "Sunday", type: "rest", label: "Full Rest", sessions: [] },
    ],
  });
  ...
  weeks.push({
    number: 13,
    phase: "Match Prep & Taper",
    focus: "Taper: stay sharp, stay fresh. Supercompensation is happening.",
    progressionGate: "Feeling fast and fresh. Legs feel light. Resting HR at baseline. Confidence high.",
    days: [
      {
        day: "Monday",
        type: "conditioning",
        ...
        sessions: [
          ...
          { name: "6x40m strides at 80%", zone: "Z3-4" },
        ],
      ...
      },
      {
        ...
        sessions: [
          { name: "1. Stab lunges - 2x45lb, 2x6. Activation, not loading." },
          { name: "2. Single-leg RDL - 45lb, 2x6." },
          { name: "3. Cable abduction - 25lb, 2x10." },
          { name: "4. Side plank hip abduction - 2x30s." },
          { name: "5. Calf raises - 20lb 2x10 both sides." },
          { name: "6. Nordic curls - 2x3 eccentric. Light." },
          { name: "UPPER BODY: DB bench 2x8, DB shoulder press 2x8. Same weights, reduced volume." },
        ],
        notes: "Movement patterns only. You are not getting weaker - you are getting faster.",
      },
      { day: "Wednesday", type: "rest", label: "Rest + Daily Physio", sessions: [] },
      {
        day: "Thursday",
        ...
        sessions: [
          { name: "10 min jog", zone: "Z2" },
          { name: "6x20m sprints with full recovery (walk back + 30s)", zone: "Z5" },
          { name: "Light agility x 4 reps" },
          { name: "10 min jog", zone: "Z2" },
        ],
      ...
      },
      {
        day: "Saturday",
        type: "conditioning",
        label: "Pickup Game - Light",
        hrTarget: "Z2-4",
        sessions: [{ name: "45 min game at 80%. Play positions, not sprints." }],
        notes: "Last game before match week. Stay healthy. Nothing to prove here.",
      },
      { day: "Sunday", type: "rest", label: "Full Rest", sessions: [] },
    ],
  });
  ...
  weeks.push({
    number: 14,
    phase: "Match Prep & Taper",
    focus: "Match week. Activation only. Arrive fresh, confident, and ready.",
    progressionGate: "YOU ARE MATCH READY. Trust the work.",
    days: [
      {
        day: "Monday",
        type: "conditioning",
        ...
        hrTarget: "Z1-2",
        sessions: [
          { name: "Movement Prep (light)" },
          { name: "15 min easy jog", zone: "Z2" },
          { name: "4x30m strides at 75%", zone: "Z3" },
        ],
        notes: "Just enough to keep legs moving. Nothing hard this week.",
      },
      {
        day: "Tuesday",
        type: "strength",
        ...
        sessions: [
          { name: "Stab lunges - 2x35lb, 2x6. Activation." },
          { name: "Single-leg RDL - 35lb, 2x6." },
          { name: "Cable abduction - 20lb, 2x8." },
          { name: "Side plank hip abduction - 2x30s." },
          { name: "Calf raises - bodyweight 2x10. Just activation." },
          { name: "UPPER BODY: DB bench 2x6 light, DB shoulder press 2x6 light." },
        ],
        notes: "Light weights, low reps. Waking up movement patterns, nothing more. No soreness allowed.",
      },
      { day: "Wednesday", type: "rest", label: "Rest + Daily Physio", sessions: [] },
      {
        day: "Thursday",
        ...
        sessions: [
          { name: "10 min jog", zone: "Z2" },
          { name: "4x20m sprints with full recovery", zone: "Z5" },
          { name: "10 min jog", zone: "Z2" },
        ],
        notes: "Last session with any intensity. Short and sharp. Feel fast.",
      },
      {
        day: "Friday",
        type: "rest",
        label: "Full Rest",
        sessions: [],
        notes: "Sleep 8+ hours. Hydrate. Eat well. Prep your kit: boots + orthotics + ankle brace + tape supplies.",
      },
      {
        day: "Saturday",
        type: "conditioning",
        ...
        sessions: [
          ...
          { name: "4x30m strides", zone: "Z3" },
          { name: "Dynamic stretching" },
          { name: "Test boot + orthotic + brace + tape combo if not already tested" },
        ],
        notes: "Just enough to feel loose and ready. Pack your bag tonight. H10 charged.",
      },
      {
        day: "Sunday",
        type: "match",
        label: "MATCH DAY - May 17",
        sessions: [
          { name: "Pre-match meal 3 hours before. Collagen + vitamin C 60 min before." },
          { name: "Full warm-up with Movement Prep drills" },
          { name: "Isometric priming: eversions + calf holds" },
          { name: "Orthotics in boots. L ankle brace on. PTFJ tape if still using." },
          { name: "H10 on - this is the data set you have been building toward" },
          { name: "Play the full 90 minutes" },
        ],
        notes: "Trust the work. Manage your energy - don't sprint everything in the first 15 min. The fitness is there. You built this over 14 weeks. Enjoy it.",
      },
    ],
  });
