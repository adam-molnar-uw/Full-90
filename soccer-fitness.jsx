...
const PROGRAM_DATA = {
  meta: {
    title: "Full 90",
    subtitle: "Soccer conditioning for a 45-year-old with FAI (L hip), inguinal nerve irritation, PTFJ, lateral chain weakness, left ankle hypermobility & plantar plate tear (R foot, orthotics)",
    phases: [
