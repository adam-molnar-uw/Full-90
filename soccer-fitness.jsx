  ...
  weeks.push({
    ...
    days: [
      ...
      { day: "Wednesday", type: "rest", label: "Rest + Daily Physio", sessions: [] },
      {
        ...
        notes: "Seated bike test PASSED (45 min, Feb 22). This session replaces the bike test — first walk/jog intervals. Total jog time: 10 min. Stay in Z2 (133–145) during jog portions.",
